...
def callback(event, tag):
    ...
    if bool(re.search(pattern, vale)) == True:
        ...
        file1.close()
        my_string_var2.set("TEMPLATE :"+new_string)
        ...
        runcommand = 'python "C:\\pysearchtool\\arg_substitute.py" -t ' +listToStr + " " + "-v" + "" +input + " " + "-o" +""+outputname
        print(runcommand)
        path = "C:\\pysearchtool\\"
        ...
        file.close()
        my_string_var.set("INPUT :"+new_string)

        labelinput.grid(column=1,row=5)
        runbutton.grid(column=0, row=5)
        cancel.place(x=950,y=121)
    else:
        string = vale
        new_string = string.split("; ", 1)[1]
        print(new_string)
        os.startfile(new_string)
...
label1hed.grid(column=0, row=0)
label1hed.config(font=('Helvetica bold', 20))

# template selected label
labeltemplate = ttk.Label(window,textvariable = my_string_var2)

# Input selection label
labelinput = ttk.Label(window, textvariable= my_string_var)

# search button
buttonfont = font.Font(family='helvetica', size=15, weight='bold')
sbutton = tk.Button(window, text="Search", height=1, width=16, command=searchcmd, font=buttonfont, bg="blue", fg="white")
sbutton.grid(column=0, row=1)

# Tag search
textbox1 = tk.Text(window, height=1, width=50)
textbox1.config(font=('Helvetica bold', 20))
...
Addtoolfont = font.Font(family='helvetica', size=15, weight='bold')
...
# Add textbox
textbox2 = tk.Text(window, height=1, width=50)
textbox2.config(font=('Helvetica bold', 20))
textbox2.grid(column=1, row=3)
textbox2.focus_set()
textbox2.grid_forget()
...
# saveTagButton
Addbuttonfont = font.Font(family='helvetica', size=15, weight='bold')
Addbutton = tk.Button(window, text="Add", height=1, width=16, command=fileexist, font=Addbuttonfont, bg="blue", fg="white")
...
result = tk.Text(window, height=27, width=100, font="Timezones", wrap=WORD, yscrollcommand=scrollbar.set)
scrollbar.config(command=result.yview)


Addtoolbuttonfont = font.Font(family='helvetica', size=15, weight='bold')
Addtoolbutton = tk.Button(window, text="Add", height=1, width=16, command=application, font=Addbuttonfont, bg="blue", fg="white")
# Addtoolbutton
...
# saveedit  button
Addbuttonfont = font.Font(family='helvetica', size=15, weight='bold')
saveedit = tk.Button(window, text="Save", height=1, width=16, command=editresult, font=Addbuttonfont, bg="blue", fg="white")
...
savetoolbuttonfont = font.Font(family='helvetica', size=15, weight='bold')
saveedittool = tk.Button(window, text="SaveTool", height=1, width=16, command=editApplication, font=savetoolbuttonfont, bg="blue", fg="white")
...
# Runbutton
runbuttonfont = font.Font(family='helvetica', size=15, weight='bold')
runbutton = tk.Button(window, text="Run", height=1, width=16, command=run, font=runbuttonfont, bg="blue", fg="white")

#cancel run button
cancelfont = font.Font(family='helvetica', size=15, weight='bold')
cancel = tk.Button(window, text="Cancel Run", height=1, width=10, command=cancelrun, font=cancelfont, bg="blue", fg="white")
